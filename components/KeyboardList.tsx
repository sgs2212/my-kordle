...
export default function KeyboardList({ handleInputWord }) {
  const test = '';

  return (
    <KeyboardDiv>
      <Keyboard>
        <KeyboardBox data-val="ㅂ" onClick={(e) => handleInputWord(e)}>
          ㅂ
        </KeyboardBox>
      ...
      <Keyboard>
        <KeyboardText data-val="input" onClick={(e) => handleInputWord(e)}>
          입력
        </KeyboardText>
